...
def test_get_submenu():
    response = client.get(f"{BASE_URL}/{menu_data.get('id')}/submenus/{submenu_data.get('id')}")
    assert response.status_code == 200
    assert response.json().get('id') == submenu_data.get('id')


def test_get_empty_list_dishes():
    response = client.get(f"{BASE_URL}/{menu_data.get('id')}/submenus/{submenu_data.get('id')}/dishes")
    assert response.status_code == 200
    assert response.json() == []


def test_create_dish():
    response = client.post(f"{BASE_URL}/{menu_data.get('id')}/submenus/{submenu_data.get('id')}/dishes", json=dish_data)
    assert response.status_code == 201
    assert 'id' in response.json()
...
def test_get_dish():
    response = client.get(f"{BASE_URL}/{menu_data.get('id')}/submenus/{submenu_data.get('id')}/dishes/{dish_data.get('id')}")
    assert response.status_code == 200
...
def test_update_submenu():
    ...
    response = client.patch(f"{BASE_URL}/{menu_data.get('id')}/submenus/{submenu_data.get('id')}", json=update_data)
    assert response.status_code == 200

    submenu_data['title'] = update_data['title']
    submenu_data['description'] = update_data['description']

    update_response = client.get(f"{BASE_URL}/{menu_data.get('id')}/submenus/{submenu_data.get('id')}")
    assert update_response.status_code == 200
...
def test_update_dish():
    ...
    response = client.patch(f"{BASE_URL}/{menu_data.get('id')}/submenus/{submenu_data.get('id')}/dishes/{dish_data.get('id')}", json=update_data)
    assert response.status_code == 200
    ...
    update_response = client.get(f"{BASE_URL}/{menu_data.get('id')}/submenus/{submenu_data.get('id')}/dishes/{dish_data.get('id')}")
    assert update_response.status_code == 200
...
def test_delete_dish():
    response = client.delete(f"{BASE_URL}/{menu_data.get('id')}/submenus/{submenu_data.get('id')}/dishes/{dish_data.get('id')}")
    assert response.status_code == 200
...
def test_delete_submenu():
    response = client.delete(f"{BASE_URL}/{menu_data.get('id')}/submenus/{submenu_data.get('id')}")
    assert response.status_code == 200
